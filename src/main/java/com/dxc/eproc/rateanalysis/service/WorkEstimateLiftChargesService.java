...
/**
 * Service Interface for managing {@link com.dxc.eproc.rateanalysis.domain.WorkEstimateLiftCharges}.
 */
public interface WorkEstimateLiftChargesService {
    ...
    /**
     * Get all the workEstimateLiftCharges.
     *
     * @param pageable the pagination information.
     * @return the list of entities.
     */
    Page<WorkEstimateLiftChargesDTO> findAll(Pageable pageable);
