...
/**
 * A DTO for the {@link com.dxc.eproc.rateanalysis.domain.WorkEstimateRoyalty} entity.
 */
public class WorkEstimateRoyaltyDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WorkEstimateRoyaltyDTO)) {
            return false;
        }

        WorkEstimateRoyaltyDTO workEstimateRoyaltyDTO = (WorkEstimateRoyaltyDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, workEstimateRoyaltyDTO.id);
    }
