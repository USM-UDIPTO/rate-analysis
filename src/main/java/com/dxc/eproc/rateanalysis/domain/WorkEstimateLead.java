 ...
 */
@Entity
@Table(name = "work_estimate_lead")
public class WorkEstimateLead implements Serializable {
    ...
    public WorkEstimateLead id(Long id) {
        this.id = id;
        return this;
    }
    ...
    public WorkEstimateLead workEstimateId(Long workEstimateId) {
    ...
    public WorkEstimateLead catWorkSorItemId(Long catWorkSorItemId) {
    ...
    public WorkEstimateLead materialMasterId(Long materialMasterId) {
    ...
    public WorkEstimateLead nhwyRoadTypeMasterId(Long nhwyRoadTypeMasterId) {
    ...
    public WorkEstimateLead subEstimateId(Long subEstimateId) {
    ...
    public WorkEstimateLead quarry(String quarry) {
        this.quarry = quarry;
        return this;
    }
    ...
    public WorkEstimateLead leadInM(BigDecimal leadInM) {
    ...
    public WorkEstimateLead leadInKm(BigDecimal leadInKm) {
    ...
    public WorkEstimateLead leadChargesM(BigDecimal leadChargesM) {
    ...
    public WorkEstimateLead leadChargesKm(BigDecimal leadChargesKm) {
    ...
    public WorkEstimateLead initialLeadRequiredYn(Boolean initialLeadRequiredYn) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WorkEstimateLead)) {
            return false;
        }
        return id != null && id.equals(((WorkEstimateLead) o).id);
    }
